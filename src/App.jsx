...
function App() {
  ...
  if (loading) {
    return <div className="min-h-screen site-background flex items-center justify-center text-white">A carregar conteúdo...</div>;
  }

  if (error || !content) {
    return <div className="min-h-screen site-background flex items-center justify-center text-white">Falha ao carregar o conteúdo. Por favor, tente novamente mais tarde.</div>;
  }
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Junta-te ao ElephantBet e desfruta das melhores apostas online. Regista-te agora e recebe bónus exclusivos!" />
      </Helmet>
